...
async def drake(first, second) -> bytes:
    ...
    with Image.open(pkgutil.get_data(__name__, f"{templates}/drake.png")) as _t:
        font = ImageFont.truetype(pkgutil.get_data(__name__, "assets/fonts/Roboto-Bold.ttf"), size=30)
        t = _t.copy()
